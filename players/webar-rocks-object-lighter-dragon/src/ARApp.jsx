...
const ARApp = (props) => {
  ...
  const _settings = {
    ...
    detectOptions: {
      ...
      trackingFactors: [0.7, 0.7, 0.7]
    },

    cameraFov: 0, // auto evaluation
    scanSettings:{
      nScaleLevels: 2,
      overlapFactors: [3, 3, 4],
      scale0Factor: 0.5
    },
  ...
  return (
    <div>
      ...
      >
        ...
        <ObjectFollower label='LIGHTER' ref={objectFollowerRef} threeHelper={threeHelper} isInitialized={isInitialized} isDetected={isDetected}/>
      </Canvas>
